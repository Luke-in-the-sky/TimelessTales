    ...
    assert result == [
        {
            "title": "Book Title",
            "author": "Author",
            "link": "https://www.gutenberg.org/ebooks/12345",
        }
    ]
...
def test_download_book_content_text_only(mock_get, api):
    ...
    result = api.download_book_content(
        "https://www.gutenberg.org/ebooks/12345", text_only=True
    )
...
def test_download_book_content_original(mock_get, api):
    ...
    result = api.download_book_content(
        "https://www.gutenberg.org/ebooks/12345", text_only=False
    )
...
def test_download_most_popular_book_from_query(
    mock_download_book_content, mock_search_books, api
):
